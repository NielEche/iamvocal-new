                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="#">
                                                <div class="card-body p-0">
                                                    ...
                                                    <button class="btn  btn-success" data-target="#"
                                                        data-toggle="modal">ADD MORE</button>
                                                </div>
                                                <!--<button class="btn btn-green btn-lg  btn-success" id="btnToggleSlideUpSize">ADD MORE </button>-->
                                            </a>

                                            <a class="dropdown-item" href="{{ route('eventspage.edit',$event->id) }}">
                                                <button name="edit_event_btn"
                                                    class="btn btn-success"> EDIT <i class="fa fa-pencil"></i></button>
                                            </a>
                                            <a class="dropdown-item" href="#">
                                                <form action="code.php" method="POST">
                                                    <input type="hidden" name="eventdelete_id" value="">
