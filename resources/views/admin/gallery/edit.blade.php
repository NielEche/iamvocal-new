                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                ...
                                <input type="text" value="{{$media['event_theme']}}" id="event_theme" name="event_theme" placeholder="Video Name"
                                    class="form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                ...
                                <input type="text" value="{{$media['event_name']}}" id="event_name" name="event_name"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                ...
                                <input type="text" value="{{$media['embed']}}" id="embed" name="embed" placeholder=""
                                    class="form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                ...
                                <input type="file" id="file_path" value="{{$media['file_path']}}" name="file_path"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 m-t-10">
                            <button value="submit" class="btn btn-primary btn-block m-t-5"> <a class="text-white"
                                    href="{{ route('eventgallery.index') }}">Cancel</a></button>
                        </div>
