                            ...
                            <div class="card-header ">
                                <div class="card-title events">
                                    <div class="carousel-item active">
                                        <img src="{{ asset('uploads/eventgallery/') }}/{{ $med->file_path }}"
                                ...
                                <div style="display: flex;">
                                    <div class="dropdown dropdown-default">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href={{"editM/".$med['id']}}>
                                                <button name="edit_event_btn" class="btn btn-success"> EDIT <i
                                                        class="fa fa-pencil"></i></button>
                                            </a>
                                            <a class="dropdown-item" href={{"deletemedia/".$med['id']}}>
...
@include('admin.partials.modals.addvideo')
@endsection
