    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header clearfix text-left pt-5">
                <h5>Edit <span class="semi-bold">About Us Details</span></h5>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                <label>Header</label>
                                <input type="text" value="{{$aboutus['header']}}" name="header" placeholder="{{$aboutus['header']}}"
                                    class="form-control" >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group ">
                                ...
                                <textarea rows="10" type="text" value="{{$aboutus['details']}}" name="details" placeholder="About Us"
                                class="form-control">{{$aboutus['details']}}</textarea>
                            </div>
                        </div>
                    </div>
