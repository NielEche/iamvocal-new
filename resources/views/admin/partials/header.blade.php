<div class="header ">
    ...
    <div class="">
        <div class="brand inline">
            <img src="{{ asset('files/media/tedxphlogo.png') }}"
                data-src-retina="{{ asset('files/media/iamvlogo.png') }}"
                data-src="{{ asset('files/media/iamvlogo.png') }}" alt="logo" width="78" height="22">
        </div>
        <ul
...
<nav class="page-sidebar" data-pages="sidebar">
    ...
    <div class="sidebar-header">
        <a href="{{ route('liquidbox.index') }}"><img src="{{ asset('files/media/iamvlogo.png') }}" alt="logo"
                class="brand" data-src="{{ asset('files/media/iamvlogo.png') }}"
                data-src-retina="{{ asset('files/media/iamvlogo.png') }}" style="width: 94px; height: 43px"></a>
    </div>
        ...
        <ul class="menu-items">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li class="">
                        <a href="{{ route('homeHeader.index') }}" style="color: #fff !important; font-weight: bold !important;">Home Page</a>
                        <span class="icon-thumbnail">HP</span>
                    </li>
                    <li class="">
                        <a href="{{ route('aboutevent.index') }}" style="color: #fff !important; font-weight: bold !important;">About Page</a>
                        <span class="icon-thumbnail">AP</span>
                    </li>
                    <li class="">
                        <a href="{{ route('events.index') }}" style="color: #fff !important; font-weight: bold !important;">Events</a>
                        <span class="icon-thumbnail">EP</span>
                    </li>
                    <li class="">
                        <a href="{{ route('career.index') }}" style="color: #fff !important; font-weight: bold !important;">Career Page</a>
                    ...
                    <li class="">
                        <a href="{{ route('eventgallery.index') }}" style="color: #fff !important; font-weight: bold !important;">Gallery
                            Page</a>
