                        ...
                        <div class="card card-transparent m-0">
                            ...
                            <div class="card-body ">
                                <div class="eventdetails">
                                    <h5 class="m-0">{{ $career->position }}</h5>
                                    <p class="m-0">{{ $career->location }}</p>
                                </div>
                                ...
                                <div style="display: flex;">
                                    <div class="dropdown dropdown-default">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href={{"editCareer/".$career['id']}}>
                                                <button name="edit_event_btn"
                                                    class="btn btn-success"> EDIT <i class="fa fa-pencil"></i></button>
                                            </a>
                                            <a class="dropdown-item" href={{"deleteCareer/".$career['id']}}>
...
@include('admin.partials.modals.addcareer')
@endsection
