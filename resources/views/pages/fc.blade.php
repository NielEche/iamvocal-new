                            ...
                            <div class="speaker-neat__image poster in-view">
                                ...
                                <figure><a style="cursor:pointer;  border:0px !important; background:none !important;"
                                        ...
                                        <img class="lazyload--el lazyload in-view__child"
                                            src="{{ asset('files/media/fc/olachi.jpg') }}" alt="" width="445"
                                            height="600">
                        ...
                        <div class="speaker-neat">
                            <div class="speaker-neat__image poster in-view">
                                ...
                                <figure><a style="cursor:pointer;  border:0px !important; background:none !important;"
                                        href="">
                                        <img class="lazyload--el lazyload in-view__child"
                                            src="{{ asset('files/media/fc/samuel.jpg') }}" alt="" width="445"
                                            height="600">
                                        <div class="poster--cover in-view in-view__child"></div>
                                    </a></figure>
                            </div>
                        ...
                        <div class="speaker-neat">
                            <div class="speaker-neat__image poster in-view">
                                ...
                                <figure><a style="cursor:pointer;  border:0px !important; background:none !important;"
                                        href="">
                                        <img class="lazyload--el lazyload in-view__child"
                                            src="{{ asset('files/media/fc/adelowo.jpg') }}" alt="" width="445"
                                            height="600">
                                        <div class="poster--cover in-view in-view__child"></div>
                                    </a></figure>
                            </div>
                        ...
                        <div class="speaker-neat">
                            <div class="speaker-neat__image poster in-view">
                                ...
                                <figure><a style="cursor:pointer;  border:0px !important; background:none !important;"
                                        href="">
                                        <img class="lazyload--el lazyload in-view__child"
                                            src="{{ asset('files/media/fc/achinike.jpg') }}" alt="" width="445"
                                            height="600">
                                        <div class="poster--cover in-view in-view__child"></div>
                                    </a></figure>
                            </div>
