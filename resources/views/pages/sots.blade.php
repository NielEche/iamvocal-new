                                ...
                                <a style="text-transform: uppercase;" class="speakersname">
                                    ...
                                    <figure><a
                                            ...
                                            <img class="lazyload--el lazyload in-view__child"
                                                src="{{ asset('files/media/sots/ibe.jpg') }}" alt="" width="445"
                                                height="600">
                            ...
                            <div class="speaker-neat__image poster in-view">
                                <a style="text-transform: uppercase;" class="speakersname">
                                    ...
                                    <figure><a
                                            ...
                                            href="">
                                            <img class="lazyload--el lazyload in-view__child"
                                                src="{{ asset('files/media/sots/jude.jpg') }}" alt="" width="445"
                                                height="600">
                                            <div class="poster--cover in-view in-view__child"></div>
                                        </a></figure>
                            </div>
                            ...
                            <div class="speaker-neat__image poster in-view">
                                <a style="text-transform: uppercase;" class="speakersname">
                                    ...
                                    <figure><a
                                            ...
                                            href="">
                                            <img class="lazyload--el lazyload in-view__child"
                                                src="{{ asset('files/media/sots/ufot.jpg') }}" alt="" width="445"
                                                height="600">
                                            <div class="poster--cover in-view in-view__child"></div>
                                        </a></figure>
                            </div>
                            ...
                            <div class="speaker-neat__image poster in-view">
                                <a style="text-transform: uppercase;" class="speakersname">
                                    ...
                                    <figure><a
                                            ...
                                            href="">
                                            <img class="lazyload--el lazyload in-view__child"
                                                src="{{ asset('files/media/sots/uche.jpg') }}" alt="" width="445"
                                                height="600">
                                            <div class="poster--cover in-view in-view__child"></div>
                                        </a></figure>
                            </div>
                            ...
                            <div class="speaker-neat__image poster in-view">
                                <a style="text-transform: uppercase;" class="speakersname">
                                    ...
                                    <figure><a
                                            ...
                                            href="">
                                            <img class="lazyload--el lazyload in-view__child"
                                                src="{{ asset('files/media/sots/dappa.jpg') }}" alt="" width="445"
                                                height="600">
                                            <div class="poster--cover in-view in-view__child"></div>
                                        </a></figure>
                            </div>
