                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 nopadding">
                                            <div style="height:442px; width:auto;" class="board__image poster in-view">
                                                <img class="lazyload--el lazyload in-view__child"
                                                    ...
                                                    alt="<?php echo e($speakers['name']); ?>" width="100%" height="100%">
                                        ...
                                        <div style="background-color: #000;"
                                            ...
                                            <div style="padding-top:2px;" class="in-view">
                                                ...
                                                <div
                                                    ...
                                                    <img style="object-fit: cover;  width:555px; height:370px;"
                                                        src="<?php echo e(asset('files/media/tedx.png')); ?>" alt="" width="555px "
                                                        height="370px">
                                            ...
                                            <div style=" padding-top:10px;" class="board__copy in-view">
                                                <p
                                                    ...
                                                    <?php echo e($speakers['talk_title']); ?>
                            ...
                            <li style="list-style:none;">
                                <div class="row">
                                    ...
                                    <div style="display:flex; align-items:flex-end;"
                                        class="pt-5 col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                        <div class="board__copy in-view">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tedxiydt/public_html/resources/views/pages/speakers/speakers.blade.php ENDPATH**/ ?>