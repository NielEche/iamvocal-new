                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 nopadding">
                                            <div style="height:442px; width:auto;" class="board__image poster in-view">
                                                <img class="lazyload--el lazyload in-view__child"
                                                    src="<?php echo e(asset('files/media/speakers/nnamdi.jpg')); ?>"
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                        <div class="board__copy in-view">
                                            ...
                                            <p style="margin-left:0px;"
                                                ...
                                                I am a Rotating Equipment specialist, Project Management Practitioner,
                                                experienced Consumer brands manager and Supply Chain professional.
                                                I am passionate about business development (SMEs), disruptive
                                                technologies, venture capitalism, digital transformation and youth
                                                empowerment. I am a Professional Member, American Society of Mechanical
                                                Engineers (ASME), a Causal Learning facilitator and a Total Productive
                                                Maintenance (TPM) Instructor.
                                                In my spare time, I love to write, research, minister to youths, watch
                                                sports, visit new places, hang out with friends and make people laugh. I
                                                hope to launch a podcast and publish a children's book series in the
                                                near future.
                                                I volunteer to support charities occasionally and hold memberships with
                                                several Not-for-Profit organizations (To Build A Nation [TBAN],
                                                University of Professional Development, Headstart Oasis, Ablaze for God
                                                International Network etc).
                                                I am happily married to my dear wife, Mfon, and we have two lovely
                                                children - Gio and Micah.
                                            </p>
                                            <p style="margin-left:0px;"
                                                ...
                                                <span class="sub-head dashed dashed--reverse dashed--hover in-view__child">
                                                    <a href="https://www.instagram.com/idmann009/"><span class="sr-only">Follow us on instagram</span><i
                                                            class="fa fa-lg fa-instagram"></i></a>
                                                    <a href="https://ng.linkedin.com/in/nnamdi-udechukwu-7753b754"><span class="sr-only">Follow us on linkedin</span><i
                                                            class="fa fa-lg fa-linkedin-square"></i></a>
                                                    <a href="https://twitter.com/nnamdi9"><span class="sr-only">Follow us on twitter</span><i
                                        ...
                                        <div class="board__copy in-view">
                                            ...
                                            <div style="display:flex; justify-content:flex-end;"
                                                ...
                                                <a style="cursor:pointer; border:0px; background:none;"
                                                    class="nopadding" href="<?php echo e(route('amanda')); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tedxiydt/public_html/resources/views/pages/speakers/nnamdi.blade.php ENDPATH**/ ?>