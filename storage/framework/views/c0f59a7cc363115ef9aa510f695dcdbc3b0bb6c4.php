        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bg-black">
                <div class="p-5 text-white">
                    <h5>TEDxPortHarcourt Salon 2019</h5>
                    <h4 class="PageActive fw-14"><span class="italic">The Story of The Story</span></h4>
                    <p class="fw-20">We live in an age where people get easily bored with routine. They are constantly
                        on the lookout for the next exciting thing without growing deep roots in anything, but every
                        story of success we read or hear points to the routine such persons had to go through to attain
                        success. Can we truly circumvent routine, if that is what forms the habits, which beget our
                        desired results? What can we learn from those who have stuck to a routine and made significant
                        progress? How do we tell when to stick to or switch from a routine? </p>
                    <br>
                    <h5 class=" fw-"><span class="PageActive">VENUE:</span> TECH CREEK ,Port Harcourt-Aba Expressway
                        opposite Pleasure Park Airforce Junction Obio/Akpor Port Harcourt</h5>
                    <h5 class=" fw-"><span class="PageActive">DATE:</span> October 05, 2019</h5>
                    <h5 class=" fw-"><span class="PageActive">TIME:</span> 12:00 Noon</h5>
                </div>
            </div>
                ...
                <div class="row">
                        ...
                        <div class="speaker-neat">
                            <div class="speaker-neat__image poster in-view">
                                <a style="text-transform: uppercase;" class="speakersname">
                                    <h5 class="in-view__child in-view__child--fadein">NNAMDI IBE</h5>
                                </a>
                                    ...
                                    <figure><a
                                            ...
                                            <img class="lazyload--el lazyload in-view__child"
                                                src="<?php echo e(asset('files/media/sots/ibe.jpg')); ?>" alt="" width="445"
                                                height="600">
                    ...
                    <div class="col-lg-4">
                        <div class="speaker-neat">
                            <div class="speaker-neat__image poster in-view">
                                <a style="text-transform: uppercase;" class="speakersname">
                                    <h5 class="in-view__child in-view__child--fadein">JUDE ANYANWU</h5>
                                </a>
                                    ...
                                    <figure><a
                                            ...
                                            href="">
                                            <img class="lazyload--el lazyload in-view__child"
                                                src="<?php echo e(asset('files/media/sots/jude.jpg')); ?>" alt="" width="445"
                                                height="600">
                                            <div class="poster--cover in-view in-view__child"></div>
                                        </a></figure>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="speaker-neat">
                            <div class="speaker-neat__image poster in-view">
                                <a style="text-transform: uppercase;" class="speakersname">
                                    <h5 class="in-view__child in-view__child--fadein">NYIEDUM UFOT</h5>
                                </a>
                                    ...
                                    <figure><a
                                            ...
                                            href="">
                                            <img class="lazyload--el lazyload in-view__child"
                                                src="<?php echo e(asset('files/media/sots/ufot.jpg')); ?>" alt="" width="445"
                                                height="600">
                                            <div class="poster--cover in-view in-view__child"></div>
                                        </a></figure>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="speaker-neat">
                            <div class="speaker-neat__image poster in-view">
                                <a style="text-transform: uppercase;" class="speakersname">
                                    <h5 class="in-view__child in-view__child--fadein">UCHE ANICHE</h5>
                                </a>
                                    ...
                                    <figure><a
                                            ...
                                            href="">
                                            <img class="lazyload--el lazyload in-view__child"
                                                src="<?php echo e(asset('files/media/sots/uche.jpg')); ?>" alt="" width="445"
                                                height="600">
                                            <div class="poster--cover in-view in-view__child"></div>
                                        </a></figure>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="speaker-neat">
                            <div class="speaker-neat__image poster in-view">
                                <a style="text-transform: uppercase;" class="speakersname">
                                    <h5 class="in-view__child in-view__child--fadein">MAPLE DAPPA</h5>
                                </a>
                                    ...
                                    <figure><a
                                            ...
                                            href="">
                                            <img class="lazyload--el lazyload in-view__child"
                                                src="<?php echo e(asset('files/media/sots/dappa.jpg')); ?>" alt="" width="445"
                                                height="600">
                                            <div class="poster--cover in-view in-view__child"></div>
                                        </a></figure>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tedxiydt/public_html/resources/views/pages/sots.blade.php ENDPATH**/ ?>