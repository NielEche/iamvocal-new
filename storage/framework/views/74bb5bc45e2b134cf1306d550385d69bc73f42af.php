        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/editpartners" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="id" value="<?php echo e($partners['id']); ?>">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                <label>Partner Image</label>
                                <input type="file" id="file_path" value="<?php echo e($partners['file_path']); ?>" name="file_path" accept="image/*"
                                    class="form-control" >
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                ...
                                <input type="text" value="<?php echo e($partners['name']); ?>" name="name" placeholder="name"
                                    class="form-control" >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                ...
                                <option value="<?php echo e($partners['type']); ?>"><?php echo e($partners['type']); ?></option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 m-t-10">
                            <button value="submit"
                                class="btn btn-primary btn-block m-t-5"> <a class="text-white" href="<?php echo e(route('eventpartners.index')); ?>">Cancel</a></button>
                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tedxiydt/public_html/resources/views/admin/partners/edit.blade.php ENDPATH**/ ?>