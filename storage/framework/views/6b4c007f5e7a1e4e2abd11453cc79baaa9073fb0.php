    ...
    <div class="">
        <div class="brand inline">
            <img src="<?php echo e(asset('files/media/tedxphlogo.png')); ?>"
                data-src-retina="<?php echo e(asset('files/media/tedxphlogo.png')); ?>"
                data-src="<?php echo e(asset('files/media/tedxphlogo.png')); ?>" alt="logo" width="78" height="22">
        </div>
        <ul
        ...
        <div class="dropdown pull-right d-lg-block d-none">
            ...
            <div class="dropdown-menu dropdown-menu-right profile-dropdown" role="menu">
                <form action="settings.php" method="post">
                    ...
                    <button type="submit" name="edit_password_btn" class="btn"><a class="dropdown-item"><i
                                class="pg-settings_small"></i> Settings</a></button>
                </form>
...
<?php $component->withAttributes(['class' => 'btn btn-primary clearfix bg-master-lighter dropdown-item text-white','href' => ''.e(route('logout')).'','onclick' => 'event.preventDefault();
                                                    this.closest(\'form\').submit();']); ?>
                        <?php echo e(__('Logout')); ?> <span class="pull-right"><i class="pg-power"></i></span>
...
<nav class="page-sidebar" data-pages="sidebar">
    ...
    <div class="sidebar-header">
        <a href="<?php echo e(route('liquidbox.index')); ?>"><img src="<?php echo e(asset('files/media/tedxphlogo.png')); ?>" alt="logo"
                class="brand" data-src="<?php echo e(asset('files/media/tedxphlogo.png')); ?>"
                data-src-retina="<?php echo e(asset('files/media/tedxphlogo.png')); ?>" style="width: 180px; height: 17.3px"></a>
    </div>
        ...
        <ul class="menu-items">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li class="">
                        <a href="about.php" style="color: #fff !important; font-weight: bold !important;">About Page</a>
                        <span class="icon-thumbnail">AP</span>
                    </li>
                    <li class="">
                        <a href="events.php" style="color: #fff !important; font-weight: bold !important;">Events</a>
                        <span class="icon-thumbnail">EP</span>
                    </li>
                    <li class="">
                        <a href="partners.php" style="color: #fff !important; font-weight: bold !important;">Partners
                        </a>
                    ...
                    <li class="">
                        <a href="gallery.php" style="color: #fff !important; font-weight: bold !important;">Gallery
                            Page</a>
                        ...
                        <a>
                            <form action="logout.php" method="POST">
                                ...
                                <button type="submit" name="logout_btn"
                                    class="btn btn-primary clearfix bg-master-lighter dropdown-item">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/tedxph/resources/views/admin/partials/header.blade.php ENDPATH**/ ?>