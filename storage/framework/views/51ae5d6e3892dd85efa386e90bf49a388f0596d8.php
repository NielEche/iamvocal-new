                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 nopadding">
                                            <div style="height:442px; width:auto;" class="board__image poster in-view">
                                                <img class="lazyload--el lazyload in-view__child"
                                                    src="<?php echo e(asset('files/media/speakers/amanda.jpg')); ?>"
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                        <div class="board__copy in-view">
                                            ...
                                            <p style="margin-left:0px;"
                                                ...
                                                Amanda is a creative enthusiast - a believer in diverse forms of the
                                                creative arts. She is a content creator, an avid writer. Amanda possesses a vivid goal to change the
                                                world with a pen and a mic.
                                                Amanda is currently pursuing a degree in Law at the Rivers State
                                                University.
                                            </p>
                                            <p style="margin-left:0px;"
                                                ...
                                                <span class="sub-head dashed dashed--reverse dashed--hover in-view__child">
                                                    <a href="https://www.instagram.com/thom_okoroh/"><span class="sr-only">Follow us
                                                            on instagram</span><i class="fa fa-lg fa-instagram"></i></a>
                                                    <a href="https://twitter.com/ebi_togu"><span class="sr-only">Follow us on
                                                            twitter</span><i class="fa fa-lg fa-twitter-square"></i></a>
                                                    <a href="https://www.facebook.com/mandiebto"><span class="sr-only">Follow us on
                                                                facebook</span><i class="fa fa-lg fa-facebook-square"></i></a>
                                                </span>
                                            </p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="board__copy in-view">
                                            ...
                                            <div style="display:flex; justify-content:flex-end;" class="">
                                                <img class="lazyload--el lazyload in-view__child nextimg"
                                                    src="<?php echo e(asset('files/media/speakers/kotrel.jpg')); ?>" alt="">
                                            </div>
                                            <div style="display:flex; justify-content:flex-end;"
                                                ...
                                                <a style="cursor:pointer; border:0px; background:none;"
                                                    class="nopadding" href="<?php echo e(route('kotrell')); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tedxiydt/public_html/resources/views/pages/speakers/amanda.blade.php ENDPATH**/ ?>