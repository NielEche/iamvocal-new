        ...
        <div class="content ">
                ...
                <div class="card card-transparent">
                    <section style="padding-bottom:0px;">
                        <header class="page-header pt-2">
                            <h1 class="page-title" style="font-weight: bold !important;">Careers</h1>
                    ...
                    <div class="card-header ">
                        <div class="pull-right">
                            <div class="col-xs-12">
                                <button data-toggle="modal" data-target="#addcareer" id="btnStickUpSizeToggler"
                                    class="btn btn-primary btn-cons"><i class="fa fa-plus"></i> Add Career
                                </button>
                            </div>
            ...
            <div class=" container-fluid  container-fixed-lg">
                <div class="row">
                    ...
                    <?php $__currentLoopData = $careers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $career): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-3 p-0">
                        <div class="card card-transparent m-0">
                            
                            <div class="card-body ">
                                <div class="eventdetails">
                                    <h5 class="m-0"><?php echo e($career->position); ?></h5>
                                    <p class="m-0"><?php echo e($career->location); ?></p>
                                </div>
                                ...
                                <div style="display: flex;">
                                    <div class="dropdown dropdown-default">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href=<?php echo e("editCareer/".$career['id']); ?>>
                                                <button name="edit_event_btn"
                                                    class="btn btn-success"> EDIT <i class="fa fa-pencil"></i></button>
                                            </a>
                                            <a class="dropdown-item" href=<?php echo e("deleteCareer/".$career['id']); ?>>
...
<?php echo $__env->make('admin.partials.modals.addcareer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/iamvocalnew/resources/views/admin/career/index.blade.php ENDPATH**/ ?>