...
<div class="modal fade " id="teamBio<?php echo e($data->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
                        ...
                        <div class="member">
                            <div class="member__info in-view in-view--in">
                                <h6 class="member__name member__name1 in-view__child in-view__child--fadein in-view__child--in"
                                    style="color: red;"><?php echo e($data->name); ?></h6>
...
<?php /**PATH /home/tedxiydt/public_html/resources/views/partials/modals/team-bio.blade.php ENDPATH**/ ?>