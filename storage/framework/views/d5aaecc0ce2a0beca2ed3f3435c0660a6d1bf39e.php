                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 nopadding">
                                            <div style="height:442px; width:auto;" class="board__image poster in-view">
                                                <img class="lazyload--el lazyload in-view__child"
                                                    src="<?php echo e(asset('files/media/speakers/kb.jpg')); ?>"
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                        <div class="board__copy in-view">
                                            ...
                                            <p style="margin-left:0px;"
                                                ...
                                                Ogbuluijah Kenneth Nsan, popularly known as Kblacktheblack, is a
                                                hip-hop/contemporary rapper and songwriter. Kblacktheblack started
                                                creating music in the year 2018 and he owes his sound to the city where
                                                he was raised, Port Harcourt, as well as legends in the mainstream rap
                                                scene.
                                            </p>
                                            <p style="margin-left:0px;"
                                        ...
                                        <div class="board__copy in-view">
                                            ...
                                            <div style="display:flex; justify-content:flex-end;" class="">
                                                <img class="lazyload--el lazyload in-view__child nextimg"
                                                    src="<?php echo e(asset('files/media/speakers/ipalibo.jpg')); ?>" alt="">
                                            </div>
                                            <div style="display:flex; justify-content:flex-end;"
                                                ...
                                                <a style="cursor:pointer; border:0px; background:none;"
                                                    class="nopadding" href="<?php echo e(route('ipalibo')); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tedxiydt/public_html/resources/views/pages/speakers/kblack.blade.php ENDPATH**/ ?>