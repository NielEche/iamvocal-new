...
<script>
  ...
  gtag('config', 'UA-51772907-1');
        ...
        <link rel="apple-touch-icon" href="<?php echo e(asset('files/pages/ico/iamvfavicon.ico')); ?>">
		<link rel="apple-touch-icon" sizes="76x76" href="<?php echo e(asset('files/pages/ico/iamvfavicon.ico')); ?>">
		<link rel="apple-touch-icon" sizes="120x120" href="<?php echo e(asset('files/pages/ico/iamvfavicon.ico')); ?>">
		<link rel="apple-touch-icon" sizes="152x152" href="<?php echo e(asset('files/pages/ico/iamvfavicon.ico')); ?>">
        <link rel="icon" type="image/x-icon" href="<?php echo e(asset('files/pages/ico/iamvfavicon.ico')); ?>" />
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/iamvocalnew/resources/views/layouts/guest.blade.php ENDPATH**/ ?>