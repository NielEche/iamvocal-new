        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/editHAbout" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="id" value="<?php echo e($homeAbout['id']); ?>">
    
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                <label>Event Theme</label>
                                <input type="text" value="<?php echo e($homeAbout['event_theme']); ?>" name="event_theme" placeholder="<?php echo e($homeAbout['event_theme']); ?>"
                                    class="form-control" >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group ">
                                ...
                                <textarea rows="10" type="text" value="<?php echo e($homeAbout['event_text']); ?>" name="event_text" placeholder="About Event"
                                class="form-control"><?php echo e($homeAbout['event_text']); ?></textarea>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/iamvocalnew/resources/views/admin/homePage/editabout.blade.php ENDPATH**/ ?>