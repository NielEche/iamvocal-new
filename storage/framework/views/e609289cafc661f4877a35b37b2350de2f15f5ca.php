                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="<?php echo e("allspeakers/".$event['id']); ?>">
                                                <button type="submit" name="add_eventspeaker_btn"
                                                    class="btn btn-success">SPEAKERS</button>
                                            </a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tedxiydt/public_html/resources/views/admin/events/index.blade.php ENDPATH**/ ?>