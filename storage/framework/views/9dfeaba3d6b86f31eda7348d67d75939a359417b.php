...
<script>
  ...
  gtag('config', 'UA-51772907-1');
        ...
        <!-- Favicon -->
        <link rel="icon" href="<?php echo e(asset('files/favicons/iamvfavicon.ico')); ?>" type="image/x-icon">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/iamvocalnew/resources/views/layouts/app.blade.php ENDPATH**/ ?>