    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('aboutevent.store')); ?>" method="POST" enctype="multipart/form-data"
                    name="team" id="team">
                    <?php echo csrf_field(); ?>
...
</div><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/iamvocalnew/resources/views/admin/partials/modals/addteam.blade.php ENDPATH**/ ?>