                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 nopadding">
                                            <div style="height:442px; width:auto;" class="board__image poster in-view">
                                                <img class="lazyload--el lazyload in-view__child"
                                                    src="<?php echo e(asset('files/media/speakers/kotrel.jpg')); ?>"
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                        <div class="board__copy in-view">
                                            ...
                                            <p style="margin-left:0px;"
                                                ...
                                                Kotrell is a soulful singer and songwriter, whose music is a reflection
                                                of his truest emotions and thoughts. His personal motto "Live, Love ànd
                                                Learn" is always clearly depicted in his songs, with the aim to showcase
                                                his values and goals as a singer on the mission to make good music that
                                                will outlive him and also make a positive impact especially in the
                                            ...
                                            <p style="margin-left:0px;"
                                                ...
                                                <span
                                                    ...
                                                    <a href="https://www.instagram.com/thekotrell/"><span
                                                            class="sr-only">Follow us on instagram</span><i
                                                            class="fa fa-lg fa-instagram"></i></a>
                                                    <a href="https://twitter.com/thekotrell"><span
                                                            class="sr-only">Follow us on twitter</span><i
                                                            class="fa fa-lg fa-twitter-square"></i></a>
                                                    <a href="https://www.facebook.com/thekotrell/"><span
                                                            class="sr-only">Follow us on facebook</span><i
                                                            class="fa fa-lg fa-facebook-square"></i></a>
                                                    <a href="https://soundcloud.com/kotrell"><span
                                                        class="sr-only">Follow us on soundcloud</span><i
                                                        class="fa fa-lg fa-soundcloud-square"></i></a>
                                                </span>
                                            </p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="board__copy in-view">
                                            ...
                                            <div style="display:flex; justify-content:flex-end;" class="">
                                                <img class="lazyload--el lazyload in-view__child nextimg"
                                                    src="<?php echo e(asset('files/media/speakers/kb.jpg')); ?>" alt="">
                                            </div>
                                            <div style="display:flex; justify-content:flex-end;"
                                                ...
                                                <a style="cursor:pointer; border:0px; background:none;"
                                                    class="nopadding" href="<?php echo e(route('kblack')); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tedxiydt/public_html/resources/views/pages/speakers/kotrell.blade.php ENDPATH**/ ?>