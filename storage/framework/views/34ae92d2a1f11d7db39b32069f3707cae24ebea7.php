        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bg-black">
                <div class="p-5 text-white">
                    <h5>TEDxPortHarcourt Salon 2018</h5>
                    <h4 class="PageActive fw-14"><span class="italic">Full Circle</span></h4>
                    <p class="fw-20">TEDx Port Harcourt Salon presents Full Circle in November 2018. A personal journey
                        back to basics and a critical consideration of an individual’s life, values and beliefs and
                        where these intersect. Full Circle promises to be a perceptive and poignant reflection. Each
                        speaker takes us back to basics and to the unique idea thjat led to the reframing of their
                        thoughts, Full Circle highlights the point of intersection where everything crystallises and we
                        never see life the same again. If you've ever wondered what direction to go next, perhaps going
                        full circle might remind you of why you started in the first place?</p>
                    <br>
                    <h5 class=" fw-"><span class="PageActive">VENUE:</span> Shell Residential Area Rumoukwurusi Port Harcourt Rivers State</h5>
                    <h5 class=" fw-"><span class="PageActive">DATE:</span> November 29, 2018</h5>
                    <h5 class=" fw-"><span class="PageActive">TIME:</span> 12 Noon</h5>
                </div>
            </div>
                ...
                <div class="row">
                        ...
                        <div class="speaker-neat">
                            <div class="speaker-neat__image poster in-view">
                                <a style="text-transform: uppercase;" class="speakersname">
                                    <h5 class="in-view__child in-view__child--fadein">OLACHI OLATUNJI</h5>
                                </a>
                                ...
                                <figure><a style="cursor:pointer;  border:0px !important; background:none !important;"
                                        ...
                                        <img class="lazyload--el lazyload in-view__child"
                                            src="<?php echo e(asset('files/media/fc/olachi.jpg')); ?>" alt="" width="445"
                                            height="600">
                            ...
                            <div class="speaker-neat__copy in-view">
                                <p style="text-transform: uppercase;" class="in-view__child in-view__child--fadein">
                                    Thinking Enthusiast, Creative,Engineer</p>
                    ...
                    <div class="col-lg-4">
                        <div class="speaker-neat">
                            <div class="speaker-neat__image poster in-view">
                                <a style="text-transform: uppercase;" class="speakersname">
                                    <h5 class="in-view__child in-view__child--fadein">SAMUEL OKONKWO</h5>
                                </a>
                                ...
                                <figure><a style="cursor:pointer;  border:0px !important; background:none !important;"
                                        href="">
                                        <img class="lazyload--el lazyload in-view__child"
                                            src="<?php echo e(asset('files/media/fc/samuel.jpg')); ?>" alt="" width="445"
                                            height="600">
                                        <div class="poster--cover in-view in-view__child"></div>
                                    </a></figure>
                            </div>
                            <div class="speaker-neat__copy in-view">
                                <p style="text-transform: uppercase;" class="in-view__child in-view__child--fadein">
                                    HR Professional, storyteller,Football fanatic,author</p>
                                <!--<p class="speaker-neat__links in-view__child in-view__child--fadein">
                                    <span class="sub-head dashed dashed--reverse dashed--hover in-view__child">
                                        <a href=""><span class="sr-only">Follow us on instagram</span><i
                                                class="fa fa-lg fa-instagram"></i></a>
                    ...
                    <div class="col-lg-4">
                        <div class="speaker-neat">
                            <div class="speaker-neat__image poster in-view">
                                <a style="text-transform: uppercase;" class="speakersname">
                                    <h5 class="in-view__child in-view__child--fadein">Oluwadamilola Adelowo</h5>
                                </a>
                                ...
                                <figure><a style="cursor:pointer;  border:0px !important; background:none !important;"
                                        href="">
                                        <img class="lazyload--el lazyload in-view__child"
                                            src="<?php echo e(asset('files/media/fc/adelowo.jpg')); ?>" alt="" width="445"
                                            height="600">
                                        <div class="poster--cover in-view in-view__child"></div>
                                    </a></figure>
                            </div>
                            <div class="speaker-neat__copy in-view">
                                <p style="text-transform: uppercase;" class="in-view__child in-view__child--fadein">
                                    Lawyer,Lover of life, risk taker, teacher, listener, leader</p>
                                <!--<p class="speaker-neat__links in-view__child in-view__child--fadein">
                                    <span class="sub-head dashed dashed--reverse dashed--hover in-view__child">
                                        <a href=""><span class="sr-only">Follow us on instagram</span><i
                                                class="fa fa-lg fa-instagram"></i></a>
                    ...
                    <div class="col-lg-4">
                        <div class="speaker-neat">
                            <div class="speaker-neat__image poster in-view">
                                <a style="text-transform: uppercase;" class="speakersname">
                                    <h5 class="in-view__child in-view__child--fadein">Achinike Ibekwe</h5>
                                </a>
                                ...
                                <figure><a style="cursor:pointer;  border:0px !important; background:none !important;"
                                        href="">
                                        <img class="lazyload--el lazyload in-view__child"
                                            src="<?php echo e(asset('files/media/fc/achinike.jpg')); ?>" alt="" width="445"
                                            height="600">
                                        <div class="poster--cover in-view in-view__child"></div>
                                    </a></figure>
                            </div>
                            <div class="speaker-neat__copy in-view">
                                <p style="text-transform: uppercase;" class="in-view__child in-view__child--fadein">
                                    Engineer,Doctor, Reggae Lover, Philanthropist, Liverpool FC supporter, Comedy Connoisseur</p>
                                <!--<p class="speaker-neat__links in-view__child in-view__child--fadein">
                                    <span class="sub-head dashed dashed--reverse dashed--hover in-view__child">
                                        <a href=""><span class="sr-only">Follow us on instagram</span><i
                                                class="fa fa-lg fa-instagram"></i></a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/tedxph/resources/views/pages/fc.blade.php ENDPATH**/ ?>