                ...
                <div class="card shadow mb-2">
                    <div class="card-body">
                        <div class="card-header p-0">
                            <h4 class=" font-weight-bold text-black">Speakers</h4>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="pull-right">
                            <div class="col-xs-12">
                                <button data-toggle="modal" data-target="#addspeakers" id="btnStickUpSizeToggler"
                                    class="btn btn-primary btn-cons"><i class="fa fa-plus"></i> Add speaker
                                </button>
                            </div>
                                    ...
                                    <div class="row column-seperation">
                                        <div class="col-lg-12">
                                            <h6 style="text-transform:uppercase; font-size:12px;" class="bold">
                                                <?php echo e($speaker->occupation); ?></h6>
                                            <a style="color: #000 !important;" href="<?php echo e($speaker->instagram); ?> "><span
                                                    class="sr-only">Follow us on instagram</span><i
                                                    class="fa fa-lg fa-instagram"></i></a>
                                            <a style="color: #000 !important;" href="<?php echo e($speaker->linkedin); ?>"><span
                                                    class="sr-only">Follow us on linkedin</span><i
                                                    class="fa fa-lg fa-linkedin-square"></i></a>
                                            <a style="color: #000 !important;" href="<?php echo e($speaker->twitter); ?>"><span
                                                    class="sr-only">Follow us on twitter</span><i
                                                    class="fa fa-lg fa-twitter-square"></i></a>
                                            <a style="color: #000 !important;" href="<?php echo e($speaker->facebook); ?>"><span
                                ...
                                <div class="tab-pane slide-left" id="<?php echo e($speaker->id); ?>2">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <h6 style="text-transform:uppercase; font-size:12px;" class="bold m-0 pb-1">
                                                <?php echo e($speaker->talk_title); ?></h6>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class='member__name member__name1 in-view__child in-view__child--fadein in-view__child--in'
                                                height="100px"><?php echo e($speaker->embed); ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tedxiydt/public_html/resources/views/admin/speakers/index.blade.php ENDPATH**/ ?>