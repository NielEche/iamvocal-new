                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 nopadding">
                                            <div style="height:442px; width:auto;" class="board__image poster in-view">
                                                <img class="lazyload--el lazyload in-view__child"
                                                    src="<?php echo e(asset('files/media/speakers/celestina.jpg')); ?>"
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                        <div class="board__copy in-view">
                                            ...
                                            <p style="text-transform: uppercase;"
                                                ...
                                                virologist and Public Health Infrastructure Expert
                                            </p>
                                            <p style="margin-left:0px;"
                                                class="indent in-view__child in-view__child--fadein text-black">
                                                Celestina is a woman on a global mission with interests in public
                                                health, women and children. She is currently the laboratory network
                                                advisor at the Nigeria Centre for Disease Control (NCDC) where she
                                                coordinates the setting up activities of the NCDC’s network of
                                                laboratories most importantly the COVID-19 testing in response to the
                                                pandemic.
                                            </p>
                                            <p style="margin-left:0px;"
                                        ...
                                        <div class="board__copy in-view">
                                            ...
                                            <div style="display:flex; justify-content:flex-end;" class="">
                                                <img class="lazyload--el lazyload in-view__child nextimg"
                                                    src="<?php echo e(asset('files/media/speakers/nnamdi.jpg')); ?>" alt="">
                                            </div>
                                            <div style="display:flex; justify-content:flex-end;"
                                                ...
                                                <a style="cursor:pointer; border:0px; background:none;"
                                                    class="nopadding" href="<?php echo e(route('nnamdi')); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tedxiydt/public_html/resources/views/pages/speakers/celestina.blade.php ENDPATH**/ ?>